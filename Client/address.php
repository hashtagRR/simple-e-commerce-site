...
<div class="col-md-12">      
 ...
 <div class="container">
    ...
    <li class="active"><a href="#" class="glyphicon glyphicon-map-marker"><br/>Location</a></li>
    <li><a href="#" class="glyphicon glyphicon-plane"><br/>Delivery Method</a></li>
  ...
  <br>
							<form action="addresshandle.php" method="post">
							 <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="firstname">Receiver's name (With initials)</label>
                                            <input type="text" required class="form-control" name="rcname">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" name="rccompany">
                                        </div>
                                    </div>
									</div>
                                    <div class="row">
									<div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" name="rcaddress">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="phone"> Receiver's Telephone</label>
                                            <input type="text" required class="form-control" name="rctp">
                                        </div>
                                    </div>
							...
							<div class="box-footer">
                                <div class="pull-left">
                                    <a href="cart.php" class="btn btn-default"><i class="glyphicon glyphicon-chevron-left"></i>Back to cart</a>
                                </div>
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary" >Continue to Delivery Method<i class="glyphicon glyphicon-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
							</form>
