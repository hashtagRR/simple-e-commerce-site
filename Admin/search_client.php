...
$sql = "SELECT * FROM cus_profile WHERE email='$product'";
				...
				?>
                                    ...
                                    <tbody>
                                        <tr>
											...
											<form action="cusdelete_handle.php" method="post">
											<td><input type="submit" value="Delete" ><i class="glyphicon glyphicon-trash"></td>
...
{
	echo "No member avilible for the email ";
}
